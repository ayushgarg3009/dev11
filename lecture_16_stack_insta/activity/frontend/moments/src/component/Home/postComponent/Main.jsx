...
class Main extends Component {
    ...
    async componentDidMount() {
        let res = await axios.get("/api/v1/user/mypost/75880fe1-5c4e-4228-a4ce-b4ab50d43e7a")
        let userResp = await axios.get("/api/v1/user/75880fe1-5c4e-4228-a4ce-b4ab50d43e7a");
